...
import Link from 'next/link';//(现在用不上这个了)
          ...
          <div className="song mb-4">
            <div className="flex items-start ">
              <div className="flex flex-col ml-4">
                ...
                <ImageWithButton image="/images/song1.jpg" alt="Song 1" link="/songs/123124" size={200} className="w-48 h-auto" />
            </div>
          </div>
          <br></br>
          <div className="song mb-4">
            <div className="flex items-start ">
              <div className="flex flex-col ml-4">
                ...
                <p className="text-xl text-green-600">推荐的歌曲</p>
                   ...
                   <ImageWithButton image="/images/song2.jpg" alt="Song 2" link="/songs" size={200} className="w-48 h-auto" />
            </div>
          </div>
          {/* 添加更多歌曲 */}
        </div>
